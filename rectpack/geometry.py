...
class Rectangle(object):
    ...
    height -
    """
    __slots__ = ('width', 'height', 'x', 'y', 'rid', 'bottom_clear', 'top_clear', 'left_clear', 'right_clear')

    def __init__(self, x, y, width, height, bottom_clear=0, top_clear=0, left_clear=0, right_clear=0, rid = None):
        """
        Args:
            x (int, float):
            y (int, float):
    ...
    def bottom(self):
        ...
        """
        return self.y - self.bottom_clear
    ...
    def top(self):
        ...
        """
        return self.y + self.height + self.top_clear
    ...
    def right(self):
        ...
        """
        return self.x + self.width + self.right_clear
    ...
    def __repr__(self):
        return "R({}, {}, {}, {}, clear B {} T {} L {} R {})".format(self.x, self.y, self.width, self.height, self.bottom_clear, self.top_clear, self.left_clear, self.right_clear)
    ...
    def contains(self, rect):
        ...
        """
        return (rect.bottom >= self.bottom and \
                rect.left >= self.left and \
